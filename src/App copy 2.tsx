    ...
    >
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        ...
        <div className="wrapper w-4/5 font-semibold flex justify-start flex-col text-left mt-20 z-20">
          <div className="text-172px text-white uppercase">MetaMobile</div>
          {/* <div
      ...
      <div className="flex h-screen w-screen flex-col items-center">
        ...
        >
          ...
          >
            ...
            <div className="text-172px">MetaMobile club.</div>
          </div>
        </div>
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        ...
        <div className="wrapper w-4/5 font-semibold flex justify-start flex-col text-left mt-20 z-20">
          <div className="text-172px">MetaMobile #01</div>
          <div
            className="w-full h-1 my-9"
            style={{
              background: '#D7620E',
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        <div className="wrapper w-4/5 font-semibold flex justify-start flex-col text-left mt-20 z-20">
          ...
          <div className="flex my-20">
            <img src={STILL_NFT_SALTFLAT_0106} className="w-1/2" alt="" />
            <img src={STILL_NFT_SALTFLAT_0105} className="w-1/2" alt="" />
          </div>
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        <div className="wrapper w-4/5 font-semibold flex justify-start flex-col text-left mt-20 z-20">
          <div className="text-172px">Our Story.</div>
          <div
            className="w-full h-1 my-9"
            style={{
              background: '#D7620E',
            ...
            {[
              ...
              return (
                <div className="item flex flex-col justify-between w-1/5">
                  <div className="title text-white text-6xl">{item}</div>
                </div>
              );
            })}
          </div>
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        <div className="wrapper w-4/5 font-semibold flex justify-start flex-col text-left mt-20 z-20">
          <div className="text-172px">Roadmap.</div>
          <div
            className="w-full h-1 my-9"
            style={{
              background: '#D7620E',
          ...
          <div className="flex justify-between my-20">
            {['Q1', 'Q2', 'Q3', 'Q4'].map((item) => {
              return (
                <div className="item flex flex-col justify-between w-1/5">
                  <div
                    className="title text-white text-6xl rounded-full"
                    style={{
                      background: '#d7620e',
                    }}
                  >
                  ...
                  <div className="text-white text-6xl mt-16">
      ...
      <div className="flex h-screen w-screen flex-col items-center relative">
        ...
        <div className="bottom flex justify-between flex-col items-center w-4/5 z-20 h-screen mt-20 mb-10">
          <div
            className="flex flex-col z-20 justify-between text-left w-full self-end font-semibold  mt-30
          "
          >
            <div>
              <div className="text-172px">Stay Tuned</div>
              <div
                className="w-full h-1 my-9"
                style={{
                  background: '#D7620E',
          ...
          <div className="text-2xl flex flex-col justify-center items-center font-light">
            <img src={LOGO4_2} width="10%" className="-mb-5" alt="" />
            <div className="text-white mb-10">Future Mobility running on Metaverse.</div>
